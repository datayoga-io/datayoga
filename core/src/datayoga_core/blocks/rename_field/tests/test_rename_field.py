...
async def test_rename_existing_field():
    ...
    block.init()
    assert await block.run([{"fname": "john", "lname": "doe"}]) == ([{"first_name": "john", "lname": "doe"}], [success])
...
async def test_rename_deep_nested_field():
    ...
    assert await block.run([{"employee": {"name": {"fname": "john", "lname": "doe"}}}]) == ([
        {"employee": {"name": {"first_name": "john", "lname": "doe"}}}], [success])
...
async def test_rename_nested_field():
    ...
    assert await block.run([{"name": {"fname": "john", "lname": "doe"}}]) == ([
        {"name": {"first_name": "john", "lname": "doe"}}], [success])
...
async def test_rename_nested_field_missing_to_field_parent():
    ...
    block.init()
    assert await block.run([{"name": {"fname": "john", "lname": "doe"}}]) == ([
        {"name": {"lname": "doe"}, "new_name": {"first_name": "john"}}], [success])
...
async def test_rename_field_with_dot():
    ...
    block.init()
    assert await block.run([{"name.fname": "john", "lname": "doe"}]) == ([{"name.first_name": "john", "lname": "doe"}], [success])
