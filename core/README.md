...
| `in`                 | Checks if the iterable contains the given element                                                                                    | Input: `{"el": "b", "itr": ["a", "b", "c"]}` <br /> Expression: `in(el, itr)` <br /> Output: `True`                                               |                                                                                                                                                                  |
| `nin`                | Checks if the iterable does not contain the given element                                                                            | Input: `{"el": "b", "itr": ["a", "b", "c"]}` <br /> Expression: `nin(el, itr)` <br /> Output: `False`                                             |                                                                                                                                                                  |
