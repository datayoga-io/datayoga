...
| `regex_replace`      | Replaces matched patterns in the string by the given replacement                                                                    | Input: `{"text": "Banana Bannnana", "pattern": r"Ban\w+", "replacement": "Apple"}` <br /> Expression: `regex_replace(text, pattern, replacement)` <br /> Output: `Apple Apple` |                                                                                                                                                                  |
