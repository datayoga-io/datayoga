...
| `regex_replace`      | Replaces matched patterns in the string by the given replacement                                                                    | Input: `{"text": "Banana Bannnana"}` <br /> Expression: `regex_replace(text, 'Ban\w+', 'Apple Apple')` <br /> Output: `Apple Apple`               |                                                                                                                                                                  |
